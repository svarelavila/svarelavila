...
| [0 - Oob](https://github.com/svarelavila/Django-0-OOB)|Entrenamiento práctico en **POO con Python y Django**, estructurado en ejercicios progresivos que abarcan desde la generación de contenido dinámico hasta la validación de estructuras HTML. Se enfoca en la reutilización del código, manejo de excepciones y buenas prácticas en el desarrollo. |
| [1 - Lib](https://github.com/svarelavila/Django_01_Librairies) |Introducción a librerías esenciales de **Python**, como `antigravity`, `path`, `requests` y `BeautifulSoup`. Los ejercicios incluyen la generación de geohashes, manipulación de archivos, búsqueda en Wikipedia y análisis de HTML con BeautifulSoup. También se cubre la configuración de entornos virtuales para el desarrollo con Django.|
| [1 - Base Django]||
| [2 - SQL] ||
| [3 - Sessions] ||
| [3 - Advanced] ||
